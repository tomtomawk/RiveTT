...
{
    [McpServerTool(Name = "get_server_capabilities"), Description("Report RiveTT's effective automatic-mode, dry-run, audit, response, selection, document, and lifecycle capability contract.")]
