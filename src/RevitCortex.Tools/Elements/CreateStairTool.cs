...
public sealed class CreateStairTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        try
        {
            ...
            scope = new StairsEditScope(doc, "MCPRVTT27: Create Stair");
            ...
            using (var tx = new Transaction(doc, "MCPRVTT27: Stair Runs"))
            {
            ...
            if (railingTypeId > 0)
            {
                try
                {
                    using var railingTx = new Transaction(doc, "MCPRVTT27: Stair Railing");
