...
public sealed class CreateDetailLineTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        try
        {
            using var tx = new Transaction(doc, "MCPRVTT27: Create Detail Lines");
...
public sealed class CreateModelLineTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        try
        {
            using var tx = new Transaction(doc, "MCPRVTT27: Create Model Lines");
            var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
            tx.Start();
...
public sealed class CreateRoomSeparationLineTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        try
        {
            using var tx = new Transaction(doc, "MCPRVTT27: Create Room Separation Lines");
            var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
            tx.Start();
...
public sealed class PlaceTitleBlockTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        try
        {
            using var tx = new Transaction(doc, "MCPRVTT27: Place Title Block");
            var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
            tx.Start();
