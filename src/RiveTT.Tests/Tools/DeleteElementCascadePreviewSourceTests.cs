...
public class DeleteElementCascadePreviewSourceTests
{
    private static string ReadTool()
    {
        return File.ReadAllText(Path.GetFullPath(Path.Combine(
            "..", "..", "..", "..", "RiveTT.Tools", "Elements", "DeleteElementTool.cs")));
    }
    ...
    {
        var src = ReadTool();
        Assert.Contains("RiveTT: Delete Preview", src);
        ...
        var realDeleteIdx = src.IndexOf("RiveTT: Delete Elements", System.StringComparison.Ordinal);
