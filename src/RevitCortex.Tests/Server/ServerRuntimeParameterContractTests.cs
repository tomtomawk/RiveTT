...
public class ServerRuntimeParameterContractTests
{
    ...
    public void EveryPublishedParameter_IsReadByTheRuntimeToolItIsSentTo()
    {
        ...
        foreach (var file in CsFiles("RevitCortex.Tools"))
        {
        ...
        foreach (var file in CsFiles("RevitCortex.Server", "Tools"))
        {
            var source = File.ReadAllText(file);
    ...
    public void CreateSheet_ForwardsTitleBlockIdAndTheRuntimeReadsIt()
    {
        ...
        var wrapper = File.ReadAllText(RepoPath("RevitCortex.Server", "Tools", "ViewTools.cs"));
        var runtime = File.ReadAllText(RepoPath("RevitCortex.Tools", "Project", "CreateSheetTool.cs"));
    ...
    {
        var runtime = File.ReadAllText(RepoPath("RevitCortex.Tools", "Elements", "ExportElementsDataTool.cs"));
    ...
    {
        var runtime = File.ReadAllText(RepoPath("RevitCortex.Tools", "Project", "DocumentLifecycleTools.cs"));
    ...
    public void SaveAs_InvalidatesEveryCachedRead()
    {
        ...
        var invalidator = File.ReadAllText(RepoPath("RevitCortex.Core", "Caching", "CacheInvalidator.cs"));
        var router = File.ReadAllText(RepoPath("RevitCortex.Plugin", "CortexRouter.cs"));
