...
public class CreateRebarCouplerTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Rebar Coupler");
...
public class SetRebarCouplerVisibilityTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Coupler Visibility");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        switch (action)
        {
            ...
            case "set_preferred":
            {
                ...
                using (var tx = new Transaction(doc, "RiveTT: Set Preferred Rebar Constraint"))
                {
                    var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
                    tx.Start();
                    try
            ...
            case "remove_preferred":
            {
                ...
                using (var tx = new Transaction(doc, "RiveTT: Remove Preferred Rebar Constraint"))
                {
                    var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
                    tx.Start();
                    try
            ...
            case "recompute":
            {
                ...
                if (!session.RequestConfirmation("recompute rebar constraints", handles.Count))
                    return CortexResult<object>.Fail(CortexErrorCode.Cancelled, "Operation cancelled by user");
                using (var tx = new Transaction(doc, "RiveTT: Recompute Rebar Constraints"))
                {
                    var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
                    tx.Start();
                    try
...
public class UnifyRebarsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Unify Rebars");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class TransferRebarAnnotationsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Transfer Rebar Annotations");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SpliceRebarTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Splice Rebar");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
            ...
            {
                var created = RebarSpliceTypeUtils.CreateRebarSpliceType(doc!, "RiveTT Lap Splice");
...
public class RemoveRebarSpliceTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Remove Rebar Splice");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
