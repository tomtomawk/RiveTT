...
public class CreateFabricAreaTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Fabric Area");
...
public class CreateFabricSheetTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Fabric Sheet");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class PlaceFabricSheetTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Place Fabric Sheet");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetFabricSheetBendProfileTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Fabric Sheet Bend Profile");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class RemoveFabricReinforcementSystemTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Remove Fabric Reinforcement System");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
