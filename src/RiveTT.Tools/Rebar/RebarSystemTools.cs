...
public class CreateAreaReinforcementTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Area Reinforcement");
...
public class CreatePathReinforcementTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Path Reinforcement");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetAreaReinforcementLayersTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Area Reinforcement Layer");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetPathReinforcementOptionsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Path Reinforcement Options");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class ConvertRebarSystemToRebarsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Convert Reinforcement To Rebars");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class RemoveRebarSystemTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Remove Reinforcement System");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
