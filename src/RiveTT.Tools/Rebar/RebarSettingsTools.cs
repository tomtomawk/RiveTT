...
public class SetReinforcementSettingsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Set Reinforcement Settings");
...
public class ManageRebarRoundingTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Manage Rebar Rounding");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        var warnings = new List<string>();
        try
...
public class ManageFabricRoundingTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Manage Fabric Rounding");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        var warnings = new List<string>();
        try
...
public class ManageRebarNumberingTool : ICortexTool
{
    ...
    private static CortexResult<object> SetNumber(Document doc, JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Rebar Number");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        var warnings = new List<string>();
        try
...
public class CreateRebarBendingDetailTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Rebar Bending Detail");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        var warnings = new List<string>();
        try
...
public class ModifyRebarBendingDetailTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Modify Rebar Bending Detail");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
