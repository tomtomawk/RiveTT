...
public class CreateGenericSteelConnectionTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Create Generic Steel Connection");
...
public class CreateSteelConnectionTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Create Steel Connection");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class ModifySteelConnectionInputsTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Modify Steel Connection Inputs");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetSteelConnectionTypeTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Change Steel Connection Type");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetSteelConnectionApprovalTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Set Steel Connection Approval");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetSteelConnectionStatusTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Set Steel Connection Status");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetSteelConnectionDefaultOrderTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Set Steel Connection Default Order");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class DeleteSteelConnectionTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Delete Steel Connection");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
