...
public class CreateSteelStructuralConnectionTypeTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Steel Connection Type");
...
public class CreateSteelConnectionHandlerTypeTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Create Steel Connection Handler Type");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class CreateDefaultSteelConnectionHandlerTypeTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc!, "RiveTT: Create Default Steel Connection Handler Type");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class SetSteelConnectionTypeFamilySymbolTool : ICortexTool
{
    ...
    public CortexResult<object> Execute(JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Set Steel Connection Type Family Symbol");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
...
public class ManageSteelApprovalTypeTool : ICortexTool
{
    ...
    private static CortexResult<object> CreateApprovalType(Document doc, JObject input, CortexSession session)
    {
        ...
        using var tx = new Transaction(doc, "RiveTT: Create Steel Approval Type");
        var txFailures = TransactionFailureHandling.SuppressWarnings(tx);
        tx.Start();
        try
        {
